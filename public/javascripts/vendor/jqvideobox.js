    		...
    		return this.each(function()
			{
				function init()
		        {
		        	if ($("#lbOverlay").length == 0)
		        	{
			        	...
			        	var _facebook_umbrella = $(document.createElement("div")).attr({id: 'facebook_umbrella'});

						_bottom.append(_close).append(_caption).append(_facebook_umbrella).append(_number).append(_clear);
		        	...
		        	prevlink = $("#lbPrevLink");
		        	nextlink = $("#lbNextLink");
		        	facebook_umbrella = $("#facebook_umbrella");
		        ...
		        function activate()
		        {
                    ...
                    var facebook_like =
                          '<iframe src="http://www.facebook.com/plugins/like.php?href=http%3A%2F%2Findia56.com%2Fv%2F'+
                          india56_id+
'&amp;layout=button_count&amp;show_faces=false&amp;width=450&amp;action=like&amp;colorscheme=light&amp;height=21" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:450px; height:21px;" allowTransparency="true"></iframe>'
                    facebook_umbrella.html(facebook_like);
		        ...
		        function insert()
		        {
					...
					bottomContainer.css({'top': (top + center.height() + 10 + 10) + "px", 'left': center.css('left')});
				...
				var india56_id = element.attr("india56_id");
                //alert(india56_id);
